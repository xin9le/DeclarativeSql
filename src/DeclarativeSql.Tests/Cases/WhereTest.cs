...
namespace DeclarativeSql.Tests.Cases
{
    public class WhereTest
    {
        ...
        public void Equal()
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Id == 1).Build();
            var expect =
@"where
    [Id] = @p1";
...
@"where
    [Id] <= @p1";
        ...
        public void Null()
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Name == null).Build();
            var expect =
@"where
    [名前] is null";
            actual.Statement.Should().Be(expect);
...
@"where
    [名前] is not null";
        ...
        public void And()
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Id > 1 && x.Name == "xin9le").Build();
            var expect =
@"where
    [Id] > @p1 and [名前] = @p2";
            actual.Statement.Should().Be(expect);
...
@"where
    [Id] > @p1 or [名前] = @p2";
        ...
        public void AndOr1()
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Id > 1 && x.Name == "xin9le" || x.Age <= 30).Build();
            var expect =
@"where
...
@"where
    ([Id] > @p1 or [名前] = @p2) and [Age] <= @p3";
        ...
        public void Contains()
        {
            ...
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => value.Contains(x.Id)).Build();
            var expect =
@"where
    [Id] in @p1";
            actual.Statement.Should().Be(expect);
...
@"where
    [Id] in @p1 or [Id] in @p2";
        ...
        {
            var id = 1;
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Id == id).Build();
            var expect =
@"where
    [Id] = @p1";
            actual.Statement.Should().Be(expect);
        ...
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Name == new string('a', 3)).Build();
            var expect =
@"where
    [名前] = @p1";
            actual.Statement.Should().Be(expect);
        ...
        public void InstanceMethod()
        {
            ...
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Name == some.InstanceMethod()).Build();
            var expect =
@"where
    [名前] = @p1";
            actual.Statement.Should().Be(expect);
        ...
        public void Lambda()
        {
            ...
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Name == getName(123)).Build();
            var expect =
@"where
    [名前] = @p1";
            actual.Statement.Should().Be(expect);
        ...
        {
            var some = new AccessorProvider();
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Age == some.InstanceProperty).Build();
            var expect =
@"where
    [Age] = @p1";
            actual.Statement.Should().Be(expect);
        ...
        {
            var ids = new[] { 1, 2, 3 };
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Id == ids[0]).Build();
            var expect =
@"where
    [Id] = @p1";
            actual.Statement.Should().Be(expect);
        ...
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Name == AccessorProvider.StaticMethod()).Build();
            var expect =
@"where
    [名前] = @p1";
            actual.Statement.Should().Be(expect);
        ...
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.Age == AccessorProvider.StaticProperty).Build();
            var expect =
@"where
    [Age] = @p1";
            actual.Statement.Should().Be(expect);
...
/*
        ...
        public void Boolean()
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.HasChildren).Build();
            var expect =
@"where
    [HasChildren] = @p1";
            actual.Statement.Should().Be(expect);
...
@"where
    [HasChildren] <> @p1";
        ...
        {
            var actual = this.DbProvider.QueryBuilder.Where<Person>(x => x.HasChildren == true || x.Id != 0 || x.Name == "xin9le" && !x.HasChildren).Build();
            var expect =
@"where
